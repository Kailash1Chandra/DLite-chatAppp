...
/**
 * Overflow menu used in the composer.
 * @param {React.ReactNode} [props.composerActions] — Custom items (e.g. attach, mention).
 * @param {boolean} [props.includeGlobalItems=true] — Show app-level items (theme, brand, home, logout).
 */
export function ComposerOverflowMenu({ composerActions = null, includeGlobalItems = true }) {
