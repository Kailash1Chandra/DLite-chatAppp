 ...
 function toneClasses(tone) {
   if (tone === 'success')
     return 'border-emerald-200/70 bg-emerald-50 text-emerald-950 dark:border-emerald-900/60 dark:bg-emerald-950/35 dark:text-emerald-50';
   if (tone === 'warning')
     return 'border-amber-200/70 bg-amber-50 text-amber-950 dark:border-amber-900/60 dark:bg-amber-950/35 dark:text-amber-50';
   if (tone === 'danger')
     return 'border-red-200/70 bg-red-50 text-red-950 dark:border-red-900/60 dark:bg-red-950/35 dark:text-red-50';
